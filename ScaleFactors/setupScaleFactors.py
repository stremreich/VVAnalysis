...
muon_ptetaratio1 = midFile1.Get('NUM_TightID_DEN_genTracks_eta_pt')
muon_ptetaratio2 = midFile2.Get('NUM_TightID_DEN_genTracks_eta_pt')
# muon_ptetaratio1 = midFile1.Get('NUM_TightID_DEN_genTracks_PAR_pt_eta/abseta_pt_ratio')
# muon_ptetaratio2 = midFile2.Get('NUM_TightID_DEN_genTracks_PAR_pt_eta/abseta_pt_ratio')
...
muIso_ptetaratio1 = misoFile1.Get('NUM_TightRelIso_DEN_TightIDandIPCut_eta_pt')
muIso_ptetaratio2 = misoFile2.Get('NUM_TightRelIso_DEN_TightIDandIPCut_eta_pt')
